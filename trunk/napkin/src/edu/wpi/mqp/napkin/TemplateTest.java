/*
 * Created on Nov 17, 2004 by Justin TemplateTest.java in edu.wpi.mqp.napkin for
 * MQP
 */
...
import edu.wpi.mqp.napkin.renderers.*;

/**
 * A test application for loading and displaying XML template files. This 
 * program allows the rendering style and the look and feel to be changed 
 * during runtime.
 * 
...
public class TemplateTest implements ActionListener {
	 ...
	 * 
	 * @param templatePath
	 *           The path to the XML template document
	 * @param renderStyle
	 *           The render style in which to draw the XML template
	 * @return An icon image of the rendered template
	 */
	private static DrawnIcon createDrawnIcon(String templatePath, int renderStyle) {
