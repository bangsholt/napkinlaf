/*
 * Created on Nov 22, 2004 by peterg UtilityShape.java in edu.wpi.mqp.napkin.geometry
 * for MQP
 */
 ...
 * used within the Napkin Drawing MQP. An important point of note is that one 
 ...
 * XMLStraightLine, which implements XMLShape, which is a subinterface of this, 
 * has a constructor thus: <tt>new XMLStraightLine(Line2D)</tt>. This allows 
 * easy access to all the functionality of these classes without having to deal 
 * with factories.
 * 
...
public interface UtilityShape extends Shape {
	...
	/**
	 * Deform this shape by the appropriate method within the renderer. Thus, the
	 * implementation of this method will nearly always take the following form:
	 * <br />
	 * <br />
	 * <tt>return r.deform</tt> <b>&lt;UtilityShape name&gt; </b>
	 * <tt>(this);</tt>
	 * 
	 * @param r
	 * @return this shape, deformed by the appropriate method within the renderer
	 */
