...
public class NapkinFileChooserUI extends BasicFileChooserUI {
    ...
    protected void installStrings(JFileChooser fc) {
        ...
        listViewButtonAccessibleName =
                UIManager.getString("FileChooser.listViewButtonAccessibleName",
                        l);

        detailsViewButtonToolTipText =
                UIManager.getString("FileChooser.detailsViewButtonToolTipText",
                        l);
                ...
                if (f != null) {
                    ...
                    if (!newDisplayName.equals(oldDisplayName)) {
                        ...
                        File f2 = fsv.createFileObject(f.getParentFile(),
                                newFileName);
                        if (!f2.exists() &&
                                NapkinFileChooserUI.this.getModel().renameFile(f, f2)) {
