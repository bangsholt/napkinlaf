/*
 * NapkinSettingsBeanInfo.java
 *
 * Created on 19 April 2006, 08:44
 */
 ...
 */
public class NapkinSettingsBeanInfo extends SimpleBeanInfo {
    
    // Bean descriptor//GEN-FIRST:BeanDescriptor
    private static BeanDescriptor beanDescriptor = new BeanDescriptor  ( net.sourceforge.napkinlaf.netbeans.NapkinSettings.class , null ); // NOI18N
    ...
    static {
        beanDescriptor.setDisplayName ( "Napkin Look & Feel" );
        beanDescriptor.setShortDescription ( "Napkin Look & Feel Settings" );//GEN-HEADEREND:BeanDescriptor
...
//GEN-LAST:Methods
    ...
    private static String iconNameC16 = "/net/sourceforge/napkinlaf/netbeans/resources/icon16.png";//GEN-BEGIN:Icons
    private static String iconNameC32 = "/net/sourceforge/napkinlaf/netbeans/resources/icon32.png";
