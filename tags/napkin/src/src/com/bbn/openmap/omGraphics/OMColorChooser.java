 ...
 * modification involves replacing the preview panel with a slider that modifies
 * the alpha transparency part of the color.
 *
 * @author dietrick
...
public class OMColorChooser {
    /**
     * Displays a dialog that lets you change a color.  Locks up the application
     * until a choice is made, returning the chosen color, or null if nothing
     * was chosen.
     *
...
/**
 * A modified ActionListener used by the JColorChooser.  Based on the one used
 * in javax.swing.JColorChooser, but with the extended capability to handle
 * transparancy.
 */
class ColorTracker
    ...
    /**
     * Get the Color set in the JColorChooser, and set the alpha value based on
    ...
    /**
     * Create the Swing components that let you change the transparency of the
     * color received from the JColorChooser.
     *
