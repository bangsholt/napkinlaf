 ...
 * XMLUtility.java in edu.wpi.mqp.napkin for MQP
 * 
 */
...
/**
 * The <tt>XMLUtility</tt> class provides some utility methods for dealing 
 * with XML information.
 * 
...
public class XMLUtility {
	 ...
	 * @param c
	 * @param name
	 * @return an XML representation of the color with the specified element name
	 */
