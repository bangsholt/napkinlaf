/*
 * Created on Nov 9, 2004 by justin TemplateItem.java in edu.wpi.mqp.napkin for
 * MQP
 */
...
public class TemplateItem implements Cloneable {
	 ...
	 * 
	 * @param drawStroke 
	 * 			Determines whether the shape's stroke is drawn
	 * @param drawFill 
	 * 			Determines whether the shape's fill is drawn
	 * @param strokeColor 
	 * 			The color of the shape's stroked lines
	 * @param strokeWeight 
	 * 			The thickness of the shape's stroked lines
	 * @param fillColor 
	 * 			The color of the shape's filled areas
	 * @param shape 
	 * 			The geometry that specifies this object's shape
	 */
