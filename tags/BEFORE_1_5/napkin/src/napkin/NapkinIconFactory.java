...
public class NapkinIconFactory implements NapkinConstants {
	...
	public static class ArrowIcon extends NapkinIcon {
		...
		/**
		 * @param pointTowards
		 *           One of NORTH, EAST, WEST, or SOUTH.
		 */
		...
		protected boolean shouldUseMark(Component c) {
			if (super.shouldUseMark(c)) return true;
	...
	/**
	 * @param templatePath
	 *           the path to an XML representation of a Template
	 * @return a new DrawnIcon in the Jot style representing the Template at the
	 *         given path
	 * @throws TemplateReadException
	 *            on IO error or when the XML file is misformatted
	 */
	public static DrawnIcon createTemplatedIcon(String templatePath) throws TemplateReadException {
	...
	/**
	 * @param template
	 *           the template to create the icon from
